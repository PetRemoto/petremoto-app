...
package com.petremoto.screen.request;
 ...
 */
public final class RequestActivity extends Activity implements
        GetJSONInterface, PostJSONInterface {
    ...
    private void acceptFriend(final int position) {
        ...
        // new PostJSONTask(this)
        // .execute(APIUtils.getApiUrlAcceptFriend(), params);
    }
    ...
    private void ignoreFriend(final int position) {
        ...
        // new PostJSONTask(this)
        // .execute(APIUtils.getApiUrlIgnoreFriend(), params);
